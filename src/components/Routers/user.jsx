...
import PaymentPageWrapper from '../pages/userside/PaymentPageWrapper';
...
import PaymentPage from '../pages/userside/PaymentPage';
...
import { PremiumProvider } from '../pages/userside/PremiumContext';
...
function UserRoutes() {
  ...
  return (
        ...
        <div>
          ...
          <Route path="/payment/:planId" element={<PaymentPageWrapper />} />
